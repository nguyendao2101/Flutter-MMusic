...
class LoginView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Ensure each LoginView gets its own instance of LoginController
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Form(
            key: controller.formKey, // Use unique GlobalKey for each LoginView
            child: Column(
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: () {
                        ...
                        // }
                        Get.toNamed(AppRouterName.splash);
                      },
